...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "jitendra@example.com" },
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Discussing new projects and professional opportunities.
            Let's build a solution tailored to your requirements.
          </p>
        </motion.div>
            ...
            <form onSubmit={handleSubmit} className="glass-card rounded-2xl p-8">
              <div className="space-y-6">
                ...
                <div className="relative">
                  <motion.label
                    className={`absolute left-4 transition-all duration-300 pointer-events-none ${focused === "name" || formState.name
                ...
                <div className="relative">
                  <motion.label
                    className={`absolute left-4 transition-all duration-300 pointer-events-none ${focused === "email" || formState.email
                        ? "top-2 text-xs text-primary"
                        : "top-4 text-muted-foreground"
                      }`}
                  >
