...
const About = () => {
  ...
  const values = [
    ...
    },
    {
      icon: Shield,
      title: "Reliability",
      description: "Delivering stable, secure, and production-ready applications.",
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        >
              ...
              <div className="relative glass-card rounded-3xl p-8 md:p-10">
                ...
                <div className="bg-background/50 rounded-xl p-4 font-mono text-sm">
                  ...
                  <div className="space-y-1 text-muted-foreground">
                    ...
                    <div className="pl-4">
                      name: <span className="text-green-400">"Jitendra"</span>,
                    </div>
                    <div className="pl-4">
                      focus: <span className="text-green-400">"Scalable Solutions"</span>,
                    </div>
                    <div className="pl-4">
          ...
          <div>
            ...
            >
              I am a professional full-stack developer with over 5 years of experience
              building high-performance web applications. My career is dedicated to
              transforming complex requirements into efficient digital solutions.
            </motion.p>
            ...
            >
              I specialize in React, TypeScript, and Node.js, focusing on writing
              maintainable code and optimizing system architecture for scale and
              reliability.
            </motion.p>
